// https://contest.yandex.ru/contest/25597/run-report/69025087/
...
O(m), где m - длина большей строки. Хотел выбрать меньшую, чтобы меньше памяти занимало решение, 
но тогда время впритык.
